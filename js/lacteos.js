  ...
  if (!list.length) {
    grid.innerHTML = `
      <div class="no-results">
        ...
        <p>No encontramos productos de lácteos con esos filtros.</p>
...
function updateHeroStats(prods) {
  ...
  // Actualizar dinámicamente el número de subcategorías
  if (subcatsEl) {
    const subcatsCount = document.querySelectorAll('#subcatFilters .filter-chip:not([data-subcat="all"])').length;
    subcatsEl.textContent = subcatsCount;
  }
}
